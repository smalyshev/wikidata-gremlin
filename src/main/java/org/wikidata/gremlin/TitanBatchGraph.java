...
public class TitanBatchGraph<T extends TransactionalGraph> implements TransactionalGraph, WrapperGraph<T> {
     ...
     */
    public TitanBatchGraph(final T graph, final VertexIDType type, final long bufferSize) {
     ...
     * @param bufferSize Defines the number of vertices and edges loaded before starting a new transaction. The larger this value, the more memory is required but the faster the loading process.
     */
    public TitanBatchGraph(final T graph, final long bufferSize) {
     ...
     * @param graph Graph to be wrapped
     */
    public TitanBatchGraph(final T graph) {
    ...
    private class BatchVertex implements Vertex {
        ...
        public void addProperty(String key, Object value) {
        	Vertex v = getCachedVertex(externalID);
        	if(!(v instanceof TitanVertex)) {
        		throw new UnsupportedOperationException("This vertex does not support addProperty");
        	}
